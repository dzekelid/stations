...
swagger: "2.0"
info:
  title: NPR Retrieve metadata for the station with the given numeric ID
  description: |-
...
paths:
  /stationfinder/v3/stations/{stationId}:
    get:
      ...
      description: This endpoint retrieves information about a given station, based
        on its numeric ID, which is consistent across all of NPR's APIs
